...
function MenuItem({ link, text, image }) {
  ...
  return (
    <div
      ...
      ref={itemRef}>
      <a
        className="flex items-center justify-center h-full relative cursor-pointer uppercase no-underline font-semibold text-foreground text-[4vh] hover:text-[#060010] focus:text-foreground focus-visible:text-[#060010]"
        href={link}
